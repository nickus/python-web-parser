...
class SimilarityService:
    ...
    def calculate_text_similarity(self, text1: str, text2: str) -> float:
        ...
        combined_score = (
            ...
            token_set_ratio * 0.2 +
            sequence_ratio * 0.1 +
            semantic_sim * 0.2  # Добавляем семантическую составляющую
        )
    ...
    def calculate_material_similarity(self, material: Material, price_item: PriceListItem) -> Tuple[float, Dict[str, float]]:
        ...
        # Логирование для 100% совпадений
    ...
    def _normalize_text(self, text: str) -> str:
        ...
        self.debug_logger.log_normalization(original_text, result)  # Логирование результата
